      ...
      <div className="absolute inset-0 bg-black/70 flex items-center justify-center">
        ...
        <div className="text-center text-white max-w-3xl px-6">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <a
              href="/tours"
              className="bg-orange-500 px-8 py-3 rounded-lg font-semibold hover:bg-orange-600 transition shadow-lg"
            >
              Explore Packages
            </a>
            ...
            <a
              ...
              className="bg-white text-black px-8 py-3 rounded-lg font-semibold hover:bg-gray-200 transition shadow"
            >
              Get Quote
            </a>
